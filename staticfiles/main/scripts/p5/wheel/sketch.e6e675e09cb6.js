...
let canvas;
let BACKGROUND_COLOR = [255, 204, 0, 0];

// Wheel related variables
let wheel;
let WHEEL_COLOR = color(255, 204, 0);

// Mouse position variables
let mousePosX, mousePosY;

// Other variables
let pAngle, v2, final_rotations, spinButton, doth_text, genreElement, font, tick_sfx, vinyl_img, picker;
let animation = [];
let wheel_imgs = [];
