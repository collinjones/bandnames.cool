...
class Wheel {
    ...
    /**
     * Stops the wheel if necessary based on the velocity or an override.
     * Updates the bandname display if it has changed.
     * Executes wheel stop actions if the wheel can be stopped and hasn't already.
     */
    stopWheelIfNecessary(override = false) {
        ...
        if (canStopWheel && !this.wheelStopActionsExecuted) {
            ...
            if(!this.isEmpyObject(this.bandnameSelected)) {
