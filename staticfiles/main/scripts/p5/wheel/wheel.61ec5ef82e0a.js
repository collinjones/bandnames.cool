...
class Wheel {
    ...
    constructor(position, radius, color, bandnames) {
        ...
        spr = createSprite(this.position.x, this.position.y);
        spr.addAnimation('wheel', this.wheel_img);
        this.populateWheel();
    }
    ...
    renderWheel() {
        image(this.wheel_img, -(width/2)-75, -(height/2), 500, 500)
    }
