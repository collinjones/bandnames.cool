...
class Wheel {
    ...
    stopWheelIfNecessary(override = false) {
        ...
        if (canStopWheel) {
            ...
            this.showDothText();
            this.chooseBandname();
            this.showGenreElement();

            if (!self.genreRequestMade) {
                self.genreRequestMade = true;
                var myCustomEvent = new CustomEvent('myCustomEvent', {
                    // Event options, if needed
                    detail: {
    ...
    showGenreElement() {
        genreElement.css('visibility', 'visible')
    }

    hideGenreElement() {
        genreElement.css('visibility', 'hidden')
    }
