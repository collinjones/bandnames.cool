...
$("#upvote-button" ).click(function(e) {
    ...
    e.preventDefault(); // Stop page from refreshing
    $.blockUI({ message: "Voting up... " + $('#bandname-selected').attr("value")}); 
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.hasOwnProperty('vote_msg')){
                $.blockUI({ message: data['vote_msg'] + " " + $('#bandname-selected').attr("value")});  
            }
...
$("#downvote-button" ).click(function(e) {
    e.preventDefault(); // Stop page from refreshing
    $.blockUI({ message: "Voting down... " + $('#bandname-selected').attr("value")}); 
    $.ajax({
        type: 'POST',
        url: '/vote',
        data: {
