class Simulation {
    ...
    drawCurrentObjectPreview() {
        if (this.gui.currentObjectDrawType == "Container") {
    ...
    createContainer(pos) {
        ...
        let multiplier = map(this.gui.getValue("Container Size"), 1, 10, -1, 5)

        this.containers.push(new Container(
            simulation, containerSize, containerWidth, partLength * multiplier, numberOfSides, pos
        ))
    }
